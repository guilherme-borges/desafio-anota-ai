...
import com.guilhermeborges.desafioanotaai.domain.category.CategoryDTO;
import com.guilhermeborges.desafioanotaai.services.CategoryService;
...
public class CategoryController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Category> update(@RequestParam("id") String id, @RequestBody CategoryDTO categoryData) {
